...
BlockBody::BlockBody() : data_entries{} {}

// BlockBody::BlockBody(const BlockBody &other) {
//     for (const auto &entry : other.data_entries) {
//         data_entries.push_back(entry->clone()); 
//     }
// }


// BlockBody &BlockBody::operator=(const BlockBody &other)
// {
//     if (this != &other)
//     {
//         data_entries.clear();
//         for (const auto &entry : other.data_entries)
//         {
//             data_entries.push_back(std::make_unique<BodyData>(*entry));
//         }
//     }
//     return *this;
// }
